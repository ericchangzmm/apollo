...
public interface ModuleDescriptor<T> extends Resourced
{
     ...
     *
     * <p> Since jijesoft-plugins v2.2, you can no longer load classes from the plugin in this method, because the OSGi
     * bundle that they will live in is not built yet.
     * Load classes in the {@link com.jijesoft.boh.core.plugin.descriptors.AbstractModuleDescriptor#enabled()} method instead.
     * 
