...
public class WaitUntil
{
     ...
     * "com.jijesoft.boh.core.plugin.startup.wait". Defaults to {@link #DEFAULT_STARTUP_WAIT}
     */
    private static final int STARTUP_WAIT = Integer.getInteger("com.jijesoft.boh.core.plugin.startup.wait", DEFAULT_STARTUP_WAIT);
