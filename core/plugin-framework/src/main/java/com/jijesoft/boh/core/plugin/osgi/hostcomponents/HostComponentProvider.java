package com.jijesoft.boh.core.plugin.osgi.hostcomponents;

/**
 * Defines an object that provides host components.  Host applications that wish to register their internal components
 * should implement this interface.  Classes like the {@link com.jijesoft.boh.core.plugin.osgi.factory.OsgiPluginFactory} use
