package com.jijesoft.boh.core.plugin.servlet.filter;
...
public class ServletFilterModuleContainerFilter implements Filter
{
    ...
    /**
     * Retrieve the DefaultServletModuleManager from your container framework.  Uses the {@link com.jijesoft.boh.core.plugin.servlet.util.ServletContextServletModuleManagerAccessor}
     * by default.
     */
