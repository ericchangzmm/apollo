...
public interface PluginController
{
     ...
     * @throws com.jijesoft.boh.core.plugin.PluginParseException if the plugin is not a valid plugin
     ...
     * @throws com.jijesoft.boh.core.plugin.PluginParseException if any plugin is not a valid plugin
     */
