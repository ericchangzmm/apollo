package com.jijesoft.boh.core.plugin.hostcontainer;

/**
 * Interface into the host application's dependency injection system.  The implementation will be expected to be able
 * to instantiate modules and possibly {@link com.jijesoft.boh.core.plugin.ModuleDescriptor} instances via constructor
