package com.jijesoft.boh.core.plugin.loaders.classloading;

import java.io.File;

/**
 * A file that is to, or has been, deployed as a plugin.  Differs to the {@link com.jijesoft.boh.core.plugin.PluginArtifact},
