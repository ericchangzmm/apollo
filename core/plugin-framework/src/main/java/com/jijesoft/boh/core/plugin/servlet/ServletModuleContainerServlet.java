...
public class ServletModuleContainerServlet extends HttpServlet
{
    ...
    /**
     * @return the DefaultServletModuleManager from your container framework.  Uses the {@link com.jijesoft.boh.core.plugin.servlet.util.ServletContextServletModuleManagerAccessor}
     * by default.
     */
