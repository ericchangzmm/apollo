...
import com.jijesoft.boh.core.plugin.osgi.util.Clazz;
...
public class HostComponentSpringStage implements TransformStage
{
    ...
    static final String SPRING_XML = "META-INF/spring/jijesoft-plugins-host-components.xml";
        ...
        if (SpringHelper.shouldGenerateFile(context, SPRING_XML))
        {
            ...
            if (context.getHostComponentRegistrations() != null)
            {
                ...
                for (HostComponentRegistration reg : context.getHostComponentRegistrations())
                {
                    ...
                    osgiService.addAttribute("class", "com.jijesoft.boh.core.plugin.osgi.bridge.external.HostComponentFactoryBean");
